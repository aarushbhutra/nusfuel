...
const createStyles = (colors) => StyleSheet.create({
  ...
  answerInput: { color: colors.text, flex: 1, fontFamily, fontSize: 32, fontWeight: "800", minWidth: 0, paddingVertical: 0 },
  ...
  input: { color: colors.text, flex: 1, fontFamily, fontSize: 18, fontWeight: "700", minWidth: 0, paddingVertical: 0 },
